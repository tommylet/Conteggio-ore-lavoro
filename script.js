...
function chiaveStorage(mese, anno) {
    return "presenze_" + anno + "_" + (mese + 1);
}
function generaTabella() {
    ...
    html += `</tbody><tfoot><tr class="totale"><td colspan="5">Totale</td>
        <td id="tot1">0</td><td id="tot2">0</td><td id="tot3">0</td><td id="tot4">0</td></tr></tfoot></table>`;
...
function calcolaTotali() {
    [5, 6, 7, 8].forEach((col, idx) => {
        ...
        let somma = 0; inputs.forEach(inp => {
